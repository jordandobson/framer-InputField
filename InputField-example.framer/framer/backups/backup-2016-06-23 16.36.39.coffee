...
# 
# The time & date types REQUIRE the value property is in a correct format & IGNORES the placeholder property.
#
...
# 	All properties will work with input type "text" but may not work with other types. Ask for help if needed.
# 	Some events won't fire if you enter incorrect content for the field type: i.e. "foo" for input type "number".
# 	Find more patterns for the Valid and Invalid events at http://html5pattern.com
# 
################################################################################
# SIMPLE EXAMPLE
...
# InputField Instance: text - Events
...
# InputField Instance: file-image
...
# InputField Instance: file-image - Events
